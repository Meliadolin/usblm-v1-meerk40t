...
from usblm_v1 import bootstrap  # noqa: F401 - DLL path for pip installs

from usb.core import NoBackendError

from usblm_v1.driver import V1Driver
from usblm_v1.lightjob import V1LiveLightJob as LiveLightJob
    ...
    def galvo_save(channel, _, filename, data=None, **kwargs):
        ...
        try:
            with open(filename, "w") as f:
                driver = V1Driver(service, force_mock=True)
